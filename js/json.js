...
var jsonBoxes = [
	{
		...
		"logoLink": "https://esportskingdom.gg/",
		"description": "I created, developed the website and write articles for Esports Kingdom - which contains articles across multiple different esports games.",
		"links": [
			{
	...
	{
		"categories": ["projects"],
		"screenshot": "seizeland-screenshot.png",
		"title": "New Seizeland",
		"logo": "seizeland-logo.png",
		"logoLink": "http://seizeland.arcton.nz/",
		"description": "New Seizeland enables the player to gather resources from New Zealand regions based on their GDP and take over NZ one comrade at a time.",
		"links": [
			{
	...
	{
		"categories": ["projects"],
		"screenshot": "l2pgames-screenshot.png",
		"title": "L2P Games",
		"logo": "l2pgames-logo.png",
		"logoLink": "https://www.l2p.games",
		"description": "Learn2Play is a curated hub for video guides for video games that provides convenient searching and filtering options for gamers of all skill levels.",
		"links": [
			{
				"link": "https://www.youtube.com/watch?v=cBF3FGBuS0g",
				"image": "icon-youtube.png",
				"text": "YouTube icon"
			},
			{
				"link": "https://www.l2p.games",
				"image": "icon-www.png",
				"text": "Website icon"
			}
		]
	...
	{
		"categories": ["projects"],
		"screenshot": "csgocards-screenshot.png",
		...
		"links": [
			{
				...
				"image": "icon-dotesports.png",
				"text": "Dot Esports icon"
			},
			{
				"link": "https://www.reddit.com/r/GlobalOffensive/comments/5nf48j/i_created_a_set_of_87_playing_cards_based_on_esl/",
				"image": "icon-reddit.png",
				"text": "Reddit icon"
			},
			{
				"link": "https://esportskingdom.gg/tcg/",
				"image": "icon-www.png",
				"text": "Website icon"
			}
		]
	...
	{
		"categories": ["projects"],
		"screenshot": "podomal-screenshot.png",
		"title": "PoDOMaL",
		"logo": "podomal-logo.png",
		"description": "Developed as my BCMS(Hons) project, PoDOMaL is a mathematical learning tool aimed at and tested with primary school aged children.",
		"links": []
	},
	{
		"categories": ["projects"],
		"screenshot": "locatio-screenshot.png",
		"title": "Locatio",
		"logo": "locatio-logo.png",
		"logoLink": "https://locatio.arcton.nz/",
		"description": "Locatio enhances online property listings with local crime statistics, demographics and more, letting you choose a home with peace of mind.",
		"links": [
			{
			...
			{
				"link": "https://www.youtube.com/watch?v=4mYbY3zTlYA",
				"image": "icon-youtube.png",
				"text": "YouTube icon"
			},
			{
				"link": "https://locatio.arcton.nz/",
				"image": "icon-www.png",
				"text": "Website icon"
			}
		]
	...
	{
		"categories": ["projects"],
		"screenshot": "nautdrafter-screenshot.png",
		"title": "NautDrafter",
		"logo": "nautdrafter-logo.png",
		"logoLink": "https://nautdrafter.bitbucket.io/nautdrafter/",
		"description": "NautDrafter is a desktop application for drafting teams for the multiplayer online battle arena game Awesomenauts.",
		"links": [
			{
				"link": "https://www.youtube.com/watch?v=gPOHC2FI_qE",
				"image": "icon-youtube.png",
				"text": "YouTube icon"
			},
			{
				"link": "https://nautdrafter.bitbucket.io/nautdrafter/",
				"image": "icon-www.png",
				"text": "Website icon"
			}
		]
	...
	{
		"categories": ["projects"],
		"screenshot": "bergs-screenshot.png",
		"title": "B.E.R.G.S",
		"logo": "bergs-logo.png",
		"logoLink": "https://play.google.com/store/apps/details?id=nz.ac.waikato.cs.comp204.syndicatez.bergs",
		"description": "Survive the hordes of zombies in this unique new mobile game. Scan barcodes to gain special abilities and boost your chance of survival!",
		"links": [
			{
				"link": "https://www.youtube.com/watch?v=40fz3ActBAc",
				"image": "icon-youtube.png",
				"text": "YouTube icon"
			},
			{
				"link": "https://play.google.com/store/apps/details?id=nz.ac.waikato.cs.comp204.syndicatez.bergs",
				"image": "icon-googleplay.png",
				"text": "Google Play icon"
			}
		]
	},
	...
	},
	{
		...
		"description": "I helped organize, moderate and host a 24hour gaming charity stream that raised over $7,500 for the Christchurch Shooting Victims' Fund.",
		"links": []
	},
	{
		"categories": ["accomplishments"],
		...
		"description": "Following on from our success in the last two years we placed second in the first two rounds and were the runners-up of the entire event.",
		"links": []
	},
	{
		"categories": ["accomplishments"],
		...
		"description": "We improved on our success of the 2016 with a first place overall in the competition and various other smaller awards.",
		"links": [
			{
	...
	},
	{
		...
		"logo": "wwenz-logo.png",
		"description": "At the WWE Live event in Auckland I was crowned the inaugural (and only) WWE Greatest Fan NZ Champion by WWE Superstars, The New Day.",
		"links": [
			{
	...
	},
	{
		...
		"description": "For our project Locatio, we walked away with 1st in the Open Government category and 2nd in Best Innovative Hack utilising Statistics NZ data.",
		"links": [
			{
				"link": "http://www.waikato.ac.nz/news-events/media/2016/govhack-nz-success-for-university-of-waikato-students",
				"image": "icon-waikatouni.png",
	...
	},
	{
		...
		"logo": "nzcsc-logo.png",
		"description": "In round one my team were the top tertiary team and the runners-up overall, we went on to be the second runners-up of the entire event.",
		"links": [
			{
	...
	},
	{
		...
		"description": "Starting at the age of 6 and training for a total of 9 years, I finally earned my black belt at Incorporated Martial Arts in 2010.",
		"links": []
	},
	...
	},
	{
		...
		"links": [
			{
				"link": "https://www.youtube.com/watch?v=zAf6rwhNIHk",
				"image": "vlog.png",
				"text": "Event Vlog"
			},
			{
	...
	},
	{
		...
		"links": [
			{
				"link": "https://www.youtube.com/watch?v=X5LPndZ4Y90",
				"image": "smash-bros.png",
				"text": "Super Smash Bros. Ultimate Early Impressions"
			},
			{
				"link": "https://www.youtube.com/watch?v=ZwG6zE9qFU4",
				"image": "pokemon-lets-go.png",
				"text": "Pokemon Let's Go Pikachu/Eevee Early Impressions"
			},
			{
	...
	},
	{
		...
		"links": [
			{
				"link": "https://www.youtube.com/watch?v=boJetxNJU8c",
				"image": "vlog.png",
				"text": "Event Vlog"
			},
			{
